...
- **Query (str)**: A general question or task.
- **Attachments (Array[RenImage|RenDocument]**: You can attach a image or document.
...
**With a PDF Document and Images**
...
from renforce import Renforce
from renforce.data import RenDocument, RenImage
from pathlib import Path
